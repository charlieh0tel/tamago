...
| `schematic.py` | `engine/schematic.ts` | done | `renderFeedSchematic`; byte-identical SVG vs Python for every feed layout (line normal/crossed, balun4 normal/crossed, choke normal/crossed, plus synthetic series-L/C cases) -- see `test/fixtures/*.svg` |
